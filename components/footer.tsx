...
//             <input type="email" placeholder="Enter Your Email Address" className="border-b border-gray-400 focus:outline-none focus:border-black flex-grow" />
//             <button type="submit" className="text-black font-semibold">SUBSCRIBE</button>
//           </form>
//         </div>
//       </div>
